...
/* This code is a Sign Up form for a restaurant website, written using React and React Router. 
It takes in input from the user and validates it, displaying an error message if any of the fields
 are left blank or if the passwords don't match*/